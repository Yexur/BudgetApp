//This will call a web API.  The web API will handle all the logic
//This page should only be hooks into the web API to get the data.
//for now this will just mock up the data
"use strict";
